...
public class Board {
    ...
    @Builder
    public Board(Integer lost_id, String user_id, String lost_name, String category, String field, Date lost_date, String lost_location, String lost_status, byte[] lost_img) {
